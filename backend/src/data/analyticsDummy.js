/**
 * Demo analytics payload for empty databases / hackathon demos.
 */
const analyticsDummy = {
  source: 'demo',
  kpis: {
    totalUsers: 248,
    totalGoals: 1240,
  ...
  departmentStats: [
    { name: 'Engineering', goal_count: 420 },
    { name: 'Sales', goal_count: 210 },
    { name: 'Marketing', goal_count: 165 },
    { name: 'Customer Success', goal_count: 145 },
    { name: 'Operations', goal_count: 180 },
    { name: 'HR', goal_count: 120 },
  ],
  totalUsers: 248,
  pendingApprovals: 18,
  openEscalations: 7,
